...
/**
 * Define the version of THA/GENERAL_THEME_HOOKS support, in case that becomes useful down the road.
 */
define( 'THA_HOOKS_VERSION', '1.0-draft' );
define( 'GENERAL_THEME_HOOKS_VERSION', '1.0' );

/**
 * Themes and Plugins can check for
 * - tha_hooks using current_theme_supports( 'tha_hooks', $hook )
 * - general_theme_hooks using current_theme_supports( 'general_theme_hooks', $hook )
 * to determine whether a theme declares itself to support this specific hook type.
 *
 * Example:
 * <code>
 * 		// Declare support for all hook types
 * 		add_theme_support( 'general_theme_hooks', array( 'all' ) );
 * 		add_theme_support( 'tha_hooks', array( 'all' ) );
 *
 * 		// Declare support for certain hook types only
 * 		add_theme_support( 'general_theme_hooks', array( 'header', 'content', 'footer' ) );
...
$hooks = array(
	 ...
	 * will be able to check whether the version of THA/GENERAL_THEME_HOOKS supplied by the theme
	 * supports Core hooks.
	 */
	//'core',
);

add_theme_support( 'general_theme_hooks', $hooks );
 ...
 * Example:
 * <code>
 * 		if ( current_theme_supports( 'general_theme_hooks', 'header' ) )
 ...
 * @return bool
 */
function general_theme_hooks_current_theme_supports( $bool, $args, $registered ) {
	return in_array( $args[0], $registered[0] ) || in_array( 'all', $registered[0] );
}
add_filter( 'current_theme_supports_general_theme_hooks', 'general_theme_hooks_current_theme_supports', 10, 3 );
add_filter( 'current_theme_supports-tha_hooks', 'general_theme_hooks_current_theme_supports', 10, 3 );
 ...
 * $tha_supports[] = 'html';
 * $general_theme_hooks_supports[] = 'html;
 */
function wp_doctype() {
 ...
 * HTML <body> hooks
 * $tha_supports[] = 'body';
 * $general_theme_hooks_supports[] = 'body';
 */
 ...
 * HTML <head> hooks
 * $tha_supports[] = 'head';
 * $general_theme_hooks_supports[] = 'head';
 */
 ...
 * $tha_supports[] = 'header';
 * $general_theme_hooks_supports[] = 'header';
 */
 ...
 * $general_theme_hooks_supports[] = 'content';
 */
 ...
 * $tha_supports[] = 'entry';
 * $general_theme_hooks_supports[] = 'post';
 */
 ...
 * $general_theme_hooks_supports[] = 'comments';
 */
 ...
 * $general_theme_hooks_supports[] = 'sidebar';
 */
 ...
 * $tha_supports[] = 'footer';
 * $general_theme_hooks_supports[] = 'footer';
 */
