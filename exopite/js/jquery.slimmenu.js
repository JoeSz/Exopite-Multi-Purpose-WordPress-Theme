...
(function ($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        init: function () {
            ...
            $menuCollapser.on('click', options.mobileTrigger, function (e) {
                e.preventDefault();
            ...
            if (windowWidth != oldWindowWidth) {
                ...
                if ($options.resizeWidth >= windowWidth) {
                    ...
                    if (!$options.initiallyVisible) {
                        $menu.hide();
                        // If menu is resized and collapsed, remove expanded class
...
$j(document).ready(function($) {
    console.log('active');
        $('.slimmenu').slimmenu(
        {
            //Get mobile breakpoint from PHP. (WordPress settings)
            resizeWidth: [#exopite-mobile-width],
            initiallyVisible: false,
            collapserTitle: 'Main Menu',
            animSpeed: 'medium',
            easingEffect: null,
